...
웹 개발, VS Code, Git을 처음 사용한다면 저장소 루트의 `START_HERE_KO.txt`를 먼저 읽고 [PASS 초보자용 개발·실행 가이드](docs/BEGINNER_GUIDE_KO.md)를 순서대로 따라 하세요. GitHub 연결, Windows/Mac 실행, 폴더와 파일의 역할, 오류 해결 방법까지 설명되어 있습니다.
...
- [초보자용 VS Code·Git·실행 가이드](docs/BEGINNER_GUIDE_KO.md)
